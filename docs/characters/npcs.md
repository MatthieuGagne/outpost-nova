...
**TBD** entries are intentionally deferred — do not invent to fill gaps.
...
**Dramatic function:** The Act 2 pivot. Their arrival is not coincidental — Vaen detected low-level emissions consistent with dormant Builder infrastructure from this region and came to investigate. The trade business on the new lane is real, but secondary. Vaen has been running two parallel tracks in exile: slowly accumulating credits toward chartering a ship capable of reaching the coordinates in uncharted space, and scanning for any signal that might give those coordinates more context. The station was not what they expected to find. Until the commander describes what they found in the lower decks. Vaen goes quiet. Not alarmed. Quiet in the way someone goes quiet when something they've been sitting with for a long time suddenly has a location.
...
**What's deferred:** The full nature of what Vaen found at the secondary Builder site — specifically what navigational data was embedded in the infrastructure, and how legible it was to Vaen at the time. Also deferred: whether the Keth ruling coalition suspects Vaen has the coordinates, or believes the suppression of their documentation was complete.

**Post-Act 3 hook:** Vaen's accumulated ship fund and the now-confirmed coordinates of the second civilization's ruins are a concrete next chapter depending on the ending. Vaen came to this station following a signal. The signal now has a source and a target. Someone might finally go.
...
## What Each NPC Knows — Act 1 Start

| Character | Derelict knowledge |
|-----------|-------------------|
...
### Thessari (Displaced)
Feline. Digitigrade. Fur in earth tones. Large, warm eyes. Quiet movers. Their world was caught in early human-Keth first contact. Neither side claimed responsibility. The Thessari are one of the last of their kind; the culture is gone, individual survivors carry it alone.

### Maevet (Unbound)
Cephalopod-inspired, semi-humanoid. Central body mass, two primary manipulators, smaller tentacle appendages. Chromatophore skin that shifts with emotional state. Move fluidly rather than walking. Never organized into governments — clans, guilds, wandering collectives. Have been in the margins of every major civilization and outlasted most of them.
