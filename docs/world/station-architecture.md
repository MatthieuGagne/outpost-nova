...
>
> From the outer edge of the bearing collar, a SINGLE connecting tube extends rightward toward the C-arc. This tube is the ONLY connection between the collar and the C-arc. It leads to a room module labeled "TRADE DOCK (Sable) — sole entry point between collar and arc". The Trade Dock module sits between the collar and the arc, connecting them. No other tube, bridge, or connection exists between the collar and the C-arc anywhere else.
>
