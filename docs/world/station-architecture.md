...
>
> From the outer edge of the bearing collar, a SINGLE perpendicular arm extends rightward to meet the C-arc. This arm IS the TRADE DOCK — it is not a corridor that leads to the Trade Dock, it is the Trade Dock itself. The Trade Dock is the connecting arm. It is collar-attached: it originates at the collar and reaches out to meet the C-arc; it is NOT an extension of the arc reaching inward. Label it "TRADE DOCK (Sable) — the connecting arm, collar-attached, sole entry point to arc". No other arm, tube, bridge, or connection exists between the collar and the C-arc anywhere else.
>
